...
# load data
dirty_data<- read_csv("outputs/census_profile-2023-12-11.csv") #change_here
...
#write CSV
filename2 <- paste0("outputs/clean_census_profile-", Sys.Date(),".csv") #change_here
...
calculate_ses_indices <- function(raw_data_filename = "data/PQ data/RAW_Census_Profile_2021_Gen3 - Copy.csv", num_den_filename = "data/PQ data/Dictionaries/PQ_dictionary_censusprofile.csv") {
  nameoffile <- "census_profile-" #change_here
