...
# load data
dirty_data<- read_csv("outputs/tgp_immigrant_2016_2021-2023-12-11.csv") #change_here
# remove non-ONS hoods
dirty2<-dirty_data[grep("ons2022|ottawa_census_division_", dirty_data$name),] #use census_division_ottawa_ for general census profile
...
#write CSV
filename2 <- paste0("outputs/clean_tgp_immigrant_2016_2021-", Sys.Date(),".csv") #change_here
...
#change_here
calculate_ses_indices <- function(raw_data_filename = "data/PQ data/WIDE_data/tgp_immigrant_2016_2021.csv", num_den_filename = "data/PQ data/Dictionaries/PQ_dictionary_censusprofile_tgp.csv") {
  nameoffile <- "tgp_immigrant_2016_2021-" #change_here
