...
#filter Ottawa hoods based on ONS_ID and drop NA cases. I changed <3200 to < 3900 to keep rural neighbourhoods
clean<- dirty3[dirty3$ONS_ID < 3900|dirty3$ONS_ID == 3506,]
