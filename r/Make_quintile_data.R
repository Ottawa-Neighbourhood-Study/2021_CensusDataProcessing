...
poptype= "genpop"
#working pop type
filetouse<- "outputs/pq outputs/processed/clean_pq_general_census_profile-2023-09-08.csv"
...
write_csv(compare3,"outputs/pq outputs/processed/quintiles/forQs_genpop.csv")
write_csv(quintiles,"outputs/pq outputs/processed/quintiles/Quintiles_genpop.csv")
